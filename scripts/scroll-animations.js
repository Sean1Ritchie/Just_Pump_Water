...
class StickyHeader {
  constructor() {
    ...
    this.lastScrollY = 0;
    this.threshold = 80;
    // Inner pages pre-set is-scrolled in HTML — never remove it
    this.initiallyScrolled = this.header.classList.contains('is-scrolled');
  ...
  onScroll() {
    ...
    // Add scrolled class after threshold; never remove on inner pages
    if (scrollY > this.threshold) {
      this.header.classList.add('is-scrolled');
    } else if (!this.initiallyScrolled) {
